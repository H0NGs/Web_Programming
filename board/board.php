...
<body>
   <table width="1000" border=0 cellspacing="0" cellpadding="0">
      <tr><td width=100% height=40 align=center><B>게 시 판</B></td></tr>	    
      <tr><td width=100%>
 ...
 ?>  
     <table border=0 cellpadding=0 cellspacing=0 width=1000>
         <tr height=40 align=center bgcolor=f0f8ff> <td width=100>번호</td> <td width=400>제목</td> 
            <td width=200>글쓴이</td><td width=200>날짜</td><td width=100>조회수</td> </tr> 
...
<?php 
   ...
   while($list=mysqli_fetch_array($list_result))  {  // 게시물 목록 출력 부분
      $i=$i+1;
	   if (($page-1)*$pg_view_cnt < $i)  {  // 출력할 해당 페이지를 찾아 레코드 출력
         $j=$j+1;
	      print "<tr height=30 valign=bottom>   <td align=center>".$list["root"]."</td>";
   ...
   if ($j==0) {
      print "<tr height=600><td colspan=5 align=center>.......... 등록된 내용이 없습니다 ..........</td></tr>";
