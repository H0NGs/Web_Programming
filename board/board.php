...
<body>
    <table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="100%" height="40" align="center"><B>게 시 판</B></td>
        </tr>
        <tr>
            <td width="100%">
                <?php // Main 시작 ===========================================
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="1000">
                    <tr height="40" align="center" bgcolor="f0f8ff">
                        <td width="100">번호</td>
                        <td width="400">제목</td>
                        <td width="200">글쓴이</td>
                        <td width="200">날짜</td>
                    ...
                    <?php
                        ...
                        while ($list = mysqli_fetch_array($list_result)) { // 게시물 목록 출력 부분
                            ...
                            if (($page - 1) * $pg_view_cnt < $i) { // 출력할 해당 페이지를 찾아 레코드 출력
                                $j = $j + 1;
                                echo "<tr height=30 valign=bottom>   <td align=center>" . $list["root"] . "</td>";
                        ...
                        if ($j < $pg_view_cnt && $j != 0) {
                            for ($k = $j; $k < $pg_view_cnt; $k++) {
                                if ($k + 1 < $pg_view_cnt) {
                                    echo "<tr height=30><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>";
                                    echo "<tr><td colspan=5>----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
                                } else {
                                    echo "<tr height=30><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>";
                                    echo "<tr><td colspan=5>==========================================================================================================================</td></tr>";
                        ...
                        if ($j == 0) {
                            echo "<tr height=600><td colspan=5 align=center>.......... 등록된 내용이 없습니다 ..........</td></tr>";
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="800">
                    <tr valign="center">
                        <td width="160">
                            <?php if ($page > $pg_view_cnt) echo "<a href=board.php?page=" . (floor(($page - 1) / $pg_view_cnt) * $pg_view_cnt) . ">◀</a>"; ?>
                        </td>
                        <td width="600">
                            <?php // 페이지 번호 목록 출력 부분
                                if ($i == ($page * $pg_view_cnt) || $page > 1) {
                                    for ($i = (floor(($page - 1) / $pg_view_cnt) * $pg_view_cnt + 1); $i <= ((floor(($page - 1) / $pg_view_cnt)) + 1) * $pg_view_cnt; $i++) {
                                        if ($i == $totalCount) {
                                            ...
                                            else echo "<a href=board.php?&page=" . $i . ">" . $i . "</a>";
                                            $i = $i + 1;
                                            break;
                                        } else if ($i == $page) echo  "<B>" . $i . "</B> | ";
                                        else echo "<a href=board.php?page=" . $i . ">" . $i . "</a>  | ";
                                    }
                                } else if ($i > 0) echo "<B>1 </B> ";
                            ?>
                        </td>
                        <td width="160">
                            <?php // 다음 페이지목록 링크
                                $i = $i - 1;
                                if ($i < $totalCount && $i > 0) echo "<a href=board.php?page=" . ($i + 1) . ">▶</a>";
                            ?>
                        </td>
                    </tr>
                    <tr>
