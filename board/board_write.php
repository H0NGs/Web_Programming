...
<form name=board_form action=board_save.php method=POST enctype="multipart/form-data">
    ...
    <table border=1 align=center cellspacing=0 width=450>
        <tr height=30>
            ...
            <td width=700><input type=text name=name maxlength=50 size=35 value='<?php print $list['writer']; ?>'></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type=file name=files><font color=BLUE>Uploaded File: </font><?php print $list['filename']; ?></td>
        </tr>
        <tr>
    ...
    <?php
        ...
        print "<a href=javascript:history.back(-1)><img src=images/board_cancel.gif width=80 height=29>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        print "<a href=javascript:check_input(document.board_form)><img src=./images/board_submit.gif width=80 height=29>";
